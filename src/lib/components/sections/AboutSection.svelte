<script lang="ts">
	...
	const mobileCareers: Array<Career> = [
		{
			companyName: '(주) 스마트스코어',
			role: 'Android 개발',
			joining: '2021.11',
			termination: '2025.4',
			companyHomePageUrl: 'https://www.smartscore.global/kr/'
		}
	];
	const backendCareers: Array<Career> = [];
