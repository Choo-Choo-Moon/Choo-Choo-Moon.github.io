...
<div class="p-8 pt-16">
	...
	<ProjectHeader
		...
		subtitle="스마트스코어 자사 골프포털 모바일 서비스"
	/>
	...
	<div>
		...
		<div class="flex flex-wrap gap-3">
			{#if project.depoloy.includes(Depoloy.Android)}
				<a
					href="https://play.google.com/store/apps/details?id=com.smartscore.rawady.smartscore&hl=ko"
					target="_blank"
				>
					<img
						class="h-auto w-50"
			...
			{#if project.depoloy.includes(Depoloy.iOS)}
				<a
					href="https://apps.apple.com/kr/app/%EC%8A%A4%EB%A7%88%ED%8A%B8%EC%8A%A4%EC%BD%94%EC%96%B4/id969887573"
					target="_blank"
				>
					<img
						class="h-auto w-50"
